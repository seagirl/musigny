...
export class Template {
  ...
  replaceVariables (content: string, target: Target): string {
    ...
    content = content.replace(/MusignyClassNameBasicLower/g, Util.lowerCamelCase(target.className))
    content = content.replace(/MusignyEntityNameBasicLower/g, Util.lowerCamelCase(target.entityName))
    content = content.replace(/MusignyDBEntityNameBasicLower/g, Util.lowerCamelCase(target.dbEntityName))
