...
describe('Parser', () => {
  ...
  it('parse', () => {
    expect(Parser.parse('hoge/entity/user.entity'))
      .toEqual(new Target('hoge/entity/user.entity', Category.unknown, Type.entity, APIType.unknown, 'user', 'user'))

    expect(Parser.parse('domain/entity/user.entity'))
      .toEqual(new Target('domain/entity/user.entity', Category.domain, Type.entity, APIType.unknown, 'user', 'user'))

    expect(Parser.parse('app/repository/user.repository'))
      .toEqual(new Target('app/repository/user.repository', Category.app, Type.repositoryInterface, APIType.unknown, 'user', 'user'))

    expect(Parser.parse('app/usecase/user/get-users.usecase'))
      .toEqual(new Target('app/usecase/user/get-users.usecase', Category.app, Type.usecase, APIType.index, 'get-users', 'user'))
    ...
    expect(Parser.parse('web/adapter/user/get-users.adapter'))
      .toEqual(new Target('web/adapter/user/get-users.adapter', Category.web, Type.adapter, APIType.index, 'get-users', 'user'))

    expect(Parser.parse('web/builder/user/get-users.builder'))
      .toEqual(new Target('web/builder/user/get-users.builder', Category.web, Type.builder, APIType.index, 'get-users', 'user'))

    expect(Parser.parse('web/express/api/user.api'))
      .toEqual(new Target('web/express/api/user.api', Category.web, Type.api, APIType.unknown, 'user', 'user'))
  })
  ...
  it('parse with option', () => {
    expect(Parser.parse('domain/entity/user.entity', {
      ...
      .toEqual(new Target('domain/entity/user.entity', Category.domain, Type.entity, APIType.unknown, 'HogeHOGE', 'fuga-fuga'))
  })
})